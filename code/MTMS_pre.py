...
data = get_data(r'experiment\exp1\maxmin')
...
model_path = r"logs\Exp1_MTMS.pth"
...
root = r'experiment\exp1\test_lack'
out = r'results\exp1\MTMS\test_lack'
